...
URL: https://huit.re/_R4AVJLP
#+REVEAL_HTML: <img src="data:image/png;base64,iVBORw0KGgoAAAANSUhEUgAAAGMAAABjAQAAAACnQIM4AAAA7UlEQVQ4jc3UsW3EMAwFUB5UsLwF%0ABGgNdVrJWsBnLWCvpE5rGNACVOfCCEMnyDmNQhd3QFTpdaQ+KeDfB/6xCGCAumS4aWq8x622IhdN%0A2Y5hfRSIF/TYTLqmuJnlingf0Mazsq6kv1hsPLvtSg4FTucLdkW4Dt4QuKRLqnAzVFUfACPCPX/3%0A95coSFx2CIY1tbwD1pR/EuuLi5txv2VOmgjt6HkKa9TEbOTNZm9YEyGANxO4RdORA5rErmmSbMcg%0AU6Dra64lLseqZFr5WYumUinY+wXFbFiWQNUx10z+WVlXx077OmFtmt7/97xCn8TzqmvusZvKAAAA%0AAElFTkSuQmCC"  height=400 width=400 >

[[https://gitlab.com/bhugueney/emacs-reveal-howto/blob/master/Presentation_FR.org][Lien vers la source de cette]] que  [[https://gitlab.com/bhugueney/emacs-reveal-howto/edit/master/Presentation_FR.org][vous pouvez éditer]] (si besoin, [[https://docs.gitlab.com/ee/user/project/members/#request-access-to-a-project][demander les droits]])

[[https://gitlab.com/bhugueney/emacs-reveal-howto/issues][Lien pour faire des suggestions / commentaires]]

[[https://bhugueney.gitlab.io/emacs-reveal-howto/Presentation.html?print-pdf][Lien vers une version imprimable
]]
[[https://interactive-social-learning.fr/Presentation.html][Link to an En_us version]]
#+BEGIN_NOTES
...
Le QCM peut facilement être édité sous forme de [[https://gitlab.com/bhugueney/emacs-reveal-howto/blob/master/quizzes/sample-quiz_FR.js][fichier text (JSON)]].
